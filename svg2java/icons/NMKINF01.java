...
public class NMKINF01 {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(3.7495315f, 0, 0, 3.7495315f, 6.992127f, 4.7244096f));
        ...
        ((GeneralPath) shape).lineTo(-0.67, -1.25);
        ((GeneralPath) shape).lineTo(-0.67, 1.25);
        ...
        // _0_0_1
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(0.67, -1.25);
        ((GeneralPath) shape).lineTo(1.85, -1.25);
        ((GeneralPath) shape).lineTo(1.85, 1.25);
        ((GeneralPath) shape).lineTo(0.67, 1.25);
        ((GeneralPath) shape).lineTo(0.67, -1.25);
