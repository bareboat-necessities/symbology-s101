...
public class BOYISDB {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(3.7611804f, 0, 0, 3.7611804f, 7.7480316f, 22.99916f));
        ...
        // _0_0_3
        shape = new Ellipse2D.Double(0.8699999451637268, -6.100000381469727, 1.100000023841858, 1.100000023841858);
        g.fill(shape);
        g.draw(shape);
