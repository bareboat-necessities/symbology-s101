...
public class NMKINF24 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_1
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(0.65, -0.3);
        ((GeneralPath) shape).lineTo(3.5, -0.3);
        ((GeneralPath) shape).lineTo(3.5, 0.3);
        ((GeneralPath) shape).lineTo(0.65, 0.3);
        ((GeneralPath) shape).lineTo(0.65, -0.3);
        ((GeneralPath) shape).closePath();
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-0.62, -3.5);
        ((GeneralPath) shape).lineTo(-0.62, 3.5);
        ((GeneralPath) shape).lineTo(0.65, 3.5);
        ((GeneralPath) shape).lineTo(0.65, -3.5);
        ((GeneralPath) shape).lineTo(-0.62, -3.5);
        ((GeneralPath) shape).closePath();
