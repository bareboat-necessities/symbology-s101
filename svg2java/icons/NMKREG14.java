...
public class NMKREG14 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-0.38, 2.45);
        ((GeneralPath) shape).lineTo(0.26, 2.45);
        ((GeneralPath) shape).lineTo(0.26, 0.81);
        ((GeneralPath) shape).lineTo(0.26, 0.57);
        ((GeneralPath) shape).lineTo(2.46, 0.57);
        ((GeneralPath) shape).lineTo(2.46, -0.71);
        ((GeneralPath) shape).lineTo(0.26, -0.71);
        ((GeneralPath) shape).lineTo(0.26, -2.59);
        ((GeneralPath) shape).lineTo(-0.38, -2.59);
        ((GeneralPath) shape).lineTo(-0.38, -0.71);
