...
public class NMKPRH18 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.82, -0.35);
        ((GeneralPath) shape).lineTo(1.82, -0.35);
        ((GeneralPath) shape).lineTo(1.38, 0.32);
        ((GeneralPath) shape).lineTo(-1.46, 0.32);
        ((GeneralPath) shape).lineTo(-1.82, -0.35);
        ((GeneralPath) shape).closePath();
        ...
        // _0_0_4
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.45, -0.89);
        ((GeneralPath) shape).lineTo(-0.14, 0.71);
        ((GeneralPath) shape).lineTo(-0.14, 0.85);
        ((GeneralPath) shape).lineTo(-0.85, 1.54);
        ((GeneralPath) shape).lineTo(-1.12, 1.3);
        ((GeneralPath) shape).lineTo(-0.41, 0.6);
        ((GeneralPath) shape).lineTo(-0.25, 0.59);
        ((GeneralPath) shape).lineTo(1.33, -1.01);
        ((GeneralPath) shape).lineTo(1.45, -0.89);
        ((GeneralPath) shape).closePath();
