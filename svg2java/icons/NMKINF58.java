...
public class NMKINF58 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-2.64, -2.63);
        ((GeneralPath) shape).lineTo(2.63, -2.63);
        ((GeneralPath) shape).lineTo(2.63, -0.41);
        ((GeneralPath) shape).lineTo(-2.64, -0.41);
        ((GeneralPath) shape).lineTo(-2.64, -2.63);
        ((GeneralPath) shape).closePath();
        ...
        // _0_0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-2.64, 0.41);
        ((GeneralPath) shape).lineTo(2.63, 0.41);
        ((GeneralPath) shape).lineTo(2.63, 2.63);
        ((GeneralPath) shape).lineTo(-2.64, 2.63);
        ((GeneralPath) shape).lineTo(-2.64, 0.41);
