...
public class BOYINL03VR {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(3.7693813f, 0, 0, 3.7693813f, 14.022099f, 26.96716f));
        ...
        // _0_0_5
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-2.43, -0.01);
        ((GeneralPath) shape).lineTo(-3.71, -1.84);
        ((GeneralPath) shape).lineTo(-2.48, -3.59);
        ...
        // _0_0_6
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.34, 1.55);
        ((GeneralPath) shape).lineTo(0.0, 3.46);
        ...
        // _0_0_7
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.4, -5.14);
        ((GeneralPath) shape).lineTo(0.0, -7.14);
        ((GeneralPath) shape).lineTo(1.39, -5.16);

        g.draw(shape);

        // _0_0_8
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(2.54, -3.53);
        ((GeneralPath) shape).lineTo(3.72, -1.84);
        ((GeneralPath) shape).lineTo(2.36, 0.1);

        g.draw(shape);

        // _0_0_9
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.23, -5.03);
        ((GeneralPath) shape).lineTo(0.0, -6.79);
        ((GeneralPath) shape).lineTo(1.22, -5.05);

        g.draw(shape);

        // _0_0_10
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-2.27, -0.13);
        ((GeneralPath) shape).lineTo(-3.47, -1.84);
        ((GeneralPath) shape).lineTo(-2.32, -3.48);

        g.draw(shape);

        // _0_0_11
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(2.37, -3.41);
        ((GeneralPath) shape).lineTo(3.47, -1.84);
        ((GeneralPath) shape).lineTo(2.19, -0.02);

        g.draw(shape);

        // _0_0_12
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.18, 1.43);
        ((GeneralPath) shape).lineTo(0.0, 3.11);
        ((GeneralPath) shape).lineTo(-1.11, 1.53);
