...
public class HRBFAC16 {
    ...
    public static void paint(Graphics2D g) {
        ...
        ((GeneralPath) shape).moveTo(1.66, -0.34);
        ((GeneralPath) shape).lineTo(-1.66, -0.34);

        g.draw(shape);

        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.68, 0.23);
        ((GeneralPath) shape).lineTo(-1.68, 0.23);
