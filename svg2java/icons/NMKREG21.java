...
public class NMKREG21 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-2.07, -4.34);
        ((GeneralPath) shape).lineTo(3.61, -4.34);
        ((GeneralPath) shape).lineTo(3.61, -4.98);
        ((GeneralPath) shape).lineTo(-2.06, -4.98);
        ((GeneralPath) shape).lineTo(-2.01, -5.18);
        ((GeneralPath) shape).lineTo(-1.95, -5.41);
        ((GeneralPath) shape).lineTo(-1.91, -5.57);
        ((GeneralPath) shape).lineTo(-2.09, -5.71);
        ((GeneralPath) shape).lineTo(-3.54, -4.66);
        ((GeneralPath) shape).lineTo(-2.08, -3.61);
        ((GeneralPath) shape).lineTo(-1.89, -3.77);
        ((GeneralPath) shape).lineTo(-1.97, -4.04);
        ((GeneralPath) shape).lineTo(-2.07, -4.34);
        ((GeneralPath) shape).closePath();
