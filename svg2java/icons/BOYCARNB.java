...
public class BOYCARNB {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_5
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.65, -3.7);
        ((GeneralPath) shape).lineTo(0.15, -3.7);
        ((GeneralPath) shape).lineTo(1.14, -4.7);
        ((GeneralPath) shape).lineTo(1.65, -3.7);
        ((GeneralPath) shape).closePath();
