...
public class NMKAC105G {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(0.3, -1.45);
        ((GeneralPath) shape).lineTo(0.7, -1.45);
        ((GeneralPath) shape).lineTo(0.0, -2.7);
        ((GeneralPath) shape).lineTo(-0.7, -1.45);
        ((GeneralPath) shape).lineTo(-0.3, -1.45);
        ((GeneralPath) shape).lineTo(-0.3, 2.81);
        ((GeneralPath) shape).lineTo(0.3, 2.81);
        ((GeneralPath) shape).lineTo(0.3, -1.45);
        ((GeneralPath) shape).closePath();
