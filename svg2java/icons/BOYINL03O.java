...
public class BOYINL03O {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(6.0606627f, 0, 0, 6.0606627f, 26.403246f, 37.03065f));
        ...
        // _0_1
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-3.07, -1.08);
        ...
        // _0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(0.0, -5.11);
        ...
        // _0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(7.05, 6.3);
        ((GeneralPath) shape).lineTo(-7.04, 6.3);
        ((GeneralPath) shape).lineTo(-7.04, -9.96);
        ((GeneralPath) shape).lineTo(7.05, -9.96);
        ((GeneralPath) shape).lineTo(7.05, 6.3);
        ((GeneralPath) shape).closePath();
