...
public class BOYINL03V {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(3.7672567f, 0, 0, 3.7672567f, 11.60315f, 20.622969f));
        ...
        // _0_0_1
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-2.01, 0.43);
        ((GeneralPath) shape).lineTo(-3.07, -1.08);
        ((GeneralPath) shape).lineTo(-2.05, -2.53);
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.11, 1.72);
        ((GeneralPath) shape).lineTo(0.0, 3.3);
        ((GeneralPath) shape).lineTo(-1.05, 1.8);

        g.draw(shape);

        // _0_0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.15, -3.81);
        ((GeneralPath) shape).lineTo(0.0, -5.46);
        ((GeneralPath) shape).lineTo(1.15, -3.83);

        g.draw(shape);

        // _0_0_4
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(2.1, -2.48);
        ((GeneralPath) shape).lineTo(3.07, -1.08);
        ((GeneralPath) shape).lineTo(1.95, 0.52);

        g.draw(shape);

        // _0_0_5
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-0.99, -3.7);
        ((GeneralPath) shape).lineTo(0.0, -5.11);
        ((GeneralPath) shape).lineTo(0.99, -3.72);

        g.draw(shape);

        // _0_0_6
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.93, -2.36);
        ((GeneralPath) shape).lineTo(2.83, -1.08);
        ((GeneralPath) shape).lineTo(1.79, 0.4);

        g.draw(shape);

        // _0_0_7
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(0.95, 1.6);
        ((GeneralPath) shape).lineTo(0.0, 2.95);
        ((GeneralPath) shape).lineTo(-0.88, 1.68);

        g.draw(shape);

        // _0_0_8
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.84, 0.31);
        ((GeneralPath) shape).lineTo(-2.82, -1.08);
        ((GeneralPath) shape).lineTo(-1.89, -2.42);
