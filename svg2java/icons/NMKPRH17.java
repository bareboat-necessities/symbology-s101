...
public class NMKPRH17 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(0.38, 1.03);
        ((GeneralPath) shape).lineTo(-1.67, 1.03);
        ((GeneralPath) shape).lineTo(0.37, -2.08);
        ((GeneralPath) shape).lineTo(0.38, 1.03);
        ((GeneralPath) shape).closePath();
        ...
        // _0_0_4
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.98, 1.22);
        ((GeneralPath) shape).lineTo(2.15, 1.22);
        ((GeneralPath) shape).lineTo(0.92, 2.0);
        ((GeneralPath) shape).lineTo(-1.11, 2.0);
        ((GeneralPath) shape).lineTo(-1.94, 1.4);
        ((GeneralPath) shape).lineTo(-1.98, 1.22);
        ((GeneralPath) shape).closePath();
