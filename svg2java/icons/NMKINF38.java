...
public class NMKINF38 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_1
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(2.84, 3.5);
        ((GeneralPath) shape).lineTo(3.5, 3.5);
        ((GeneralPath) shape).lineTo(3.5, 2.85);
        ((GeneralPath) shape).lineTo(-2.86, -3.5);
        ((GeneralPath) shape).lineTo(-3.5, -3.5);
        ((GeneralPath) shape).lineTo(-3.5, -2.84);
        ((GeneralPath) shape).lineTo(2.84, 3.5);
        ((GeneralPath) shape).closePath();
