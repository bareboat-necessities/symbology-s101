...
public class NMKREG18 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-2.52, 1.6);
        ((GeneralPath) shape).lineTo(-0.86, -0.05);
        ((GeneralPath) shape).lineTo(-2.52, -1.7);
        ((GeneralPath) shape).lineTo(-2.52, 1.6);
        ((GeneralPath) shape).closePath();
