...
public class NMKREG10 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new Ellipse2D.Double(-1.7200000286102295, -0.5099999904632568, 1.0199999809265137, 1.0199999809265137);
        g.setPaint(BLACK);
        g.fill(shape);
        g.draw(shape);

        // _0_0_3
        shape = new Ellipse2D.Double(0.690000057220459, -0.5099999904632568, 1.0199999809265137, 1.0199999809265137);
        g.fill(shape);
        g.draw(shape);

        // _0_0_4
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.21, -0.51);
        ((GeneralPath) shape).lineTo(1.2, -0.51);
        ((GeneralPath) shape).lineTo(1.2, 0.51);
        ((GeneralPath) shape).lineTo(-1.21, 0.51);
        ((GeneralPath) shape).lineTo(-1.21, -0.51);
        ((GeneralPath) shape).closePath();
