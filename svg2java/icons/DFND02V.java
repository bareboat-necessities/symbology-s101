...
public class DFND02V {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(3.7672567f, 0, 0, 3.7672567f, 11.377115f, 20.057882f));
        ...
        ((GeneralPath) shape).lineTo(1.85, -0.59);
        ...
        // _0_0_1
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.95, 0.58);
        ((GeneralPath) shape).lineTo(-3.01, -0.93);
        ((GeneralPath) shape).lineTo(-1.99, -2.38);
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.17, 1.87);
        ((GeneralPath) shape).lineTo(0.06, 3.45);
        ((GeneralPath) shape).lineTo(-0.99, 1.95);

        g.draw(shape);

        // _0_0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.09, -3.66);
        ((GeneralPath) shape).lineTo(0.06, -5.31);
        ((GeneralPath) shape).lineTo(1.21, -3.68);

        g.draw(shape);

        // _0_0_4
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(2.16, -2.32);
        ((GeneralPath) shape).lineTo(3.13, -0.93);
        ((GeneralPath) shape).lineTo(2.01, 0.67);

        g.draw(shape);

        // _0_0_5
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-0.93, -3.54);
        ((GeneralPath) shape).lineTo(0.06, -4.96);
        ((GeneralPath) shape).lineTo(1.04, -3.56);

        g.draw(shape);

        // _0_0_6
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.99, -2.21);
        ((GeneralPath) shape).lineTo(2.89, -0.93);
        ((GeneralPath) shape).lineTo(1.85, 0.56);

        g.draw(shape);

        // _0_0_7
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.78, 0.46);
        ((GeneralPath) shape).lineTo(-2.76, -0.93);
        ((GeneralPath) shape).lineTo(-1.83, -2.26);

        g.draw(shape);

        // _0_0_8
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.01, 1.76);
        ((GeneralPath) shape).lineTo(0.06, 3.1);
