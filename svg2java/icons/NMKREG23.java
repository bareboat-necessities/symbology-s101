...
public class NMKREG23 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new Ellipse2D.Double(-1.7200000286102295, -5.289999961853027, 1.0199999809265137, 1.0199999809265137);
        g.setPaint(BLACK);
        g.fill(shape);
        g.draw(shape);

        // _0_0_3
        shape = new Ellipse2D.Double(0.690000057220459, -5.289999961853027, 1.0199999809265137, 1.0199999809265137);
        g.fill(shape);
        g.draw(shape);

        // _0_0_4
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.21, -5.29);
        ((GeneralPath) shape).lineTo(1.2, -5.29);
        ((GeneralPath) shape).lineTo(1.2, -4.26);
        ((GeneralPath) shape).lineTo(-1.21, -4.27);
        ((GeneralPath) shape).lineTo(-1.21, -5.29);
        ((GeneralPath) shape).closePath();
