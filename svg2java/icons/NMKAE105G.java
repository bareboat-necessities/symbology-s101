...
public class NMKAE105G {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.07, 2.24);
        ((GeneralPath) shape).lineTo(-1.87, 2.24);
        ((GeneralPath) shape).lineTo(-1.87, -2.24);
        ((GeneralPath) shape).lineTo(-1.07, -2.24);
        ((GeneralPath) shape).lineTo(-1.07, 2.24);
        ((GeneralPath) shape).closePath();
        ...
        // _0_0_3
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.07, -0.4);
        ((GeneralPath) shape).lineTo(1.07, -0.4);
        ((GeneralPath) shape).lineTo(1.07, 0.4);
        ((GeneralPath) shape).lineTo(-1.07, 0.4);
        ((GeneralPath) shape).lineTo(-1.07, -0.4);
        ((GeneralPath) shape).closePath();
