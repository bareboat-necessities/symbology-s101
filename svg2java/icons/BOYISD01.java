...
public class BOYISD01 {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(3.7473614f, 0, 0, 3.7473614f, 2.8105211f, 35.827988f));
        ...
        // _0_0_4
        shape = new Ellipse2D.Double(-0.06000000238418579, -7.619999885559082, 1.4600000381469727, 1.4600000381469727);
        g.fill(shape);
        g.draw(shape);

        // _0_0_5
        shape = new Ellipse2D.Double(0.12000000476837158, -9.520000457763672, 1.4600000381469727, 1.4600000381469727);
        g.fill(shape);
        g.draw(shape);
