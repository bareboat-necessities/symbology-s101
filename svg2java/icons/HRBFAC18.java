...
public class HRBFAC18 {
    ...
    public static void paint(Graphics2D g) {
        ...
        ((GeneralPath) shape).moveTo(-0.28, -1.17);
        ((GeneralPath) shape).lineTo(0.26, -1.17);
        ((GeneralPath) shape).lineTo(0.26, 1.18);
        ((GeneralPath) shape).lineTo(-0.28, 1.18);
        ((GeneralPath) shape).lineTo(-0.28, -1.17);
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.17, 0.29);
        ((GeneralPath) shape).lineTo(-1.17, 0.29);
        ((GeneralPath) shape).lineTo(-1.17, -0.29);
        ((GeneralPath) shape).lineTo(1.17, -0.29);
        ((GeneralPath) shape).lineTo(1.17, 0.29);
        ((GeneralPath) shape).closePath();
