...
public class NMKREG12 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new Ellipse2D.Double(-0.5099999904632568, 0.7000000476837158, 1.0199999809265137, 1.0199999809265137);
        g.setPaint(BLACK);
        g.fill(shape);
        g.draw(shape);

        // _0_0_3
        shape = new Ellipse2D.Double(-0.5099999904632568, -1.7100000381469727, 1.0199999809265137, 1.0199999809265137);
        g.fill(shape);
        g.draw(shape);

        // _0_0_4
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-0.51, 1.21);
        ((GeneralPath) shape).lineTo(-0.51, -1.2);
        ((GeneralPath) shape).lineTo(0.51, -1.2);
        ((GeneralPath) shape).lineTo(0.51, 1.21);
        ((GeneralPath) shape).lineTo(-0.51, 1.21);
        ((GeneralPath) shape).closePath();
