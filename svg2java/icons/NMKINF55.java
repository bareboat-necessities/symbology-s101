...
public class NMKINF55 {
    ...
    public static void paint(Graphics2D g) {
        ...
        // _0_0_2
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(-1.33, -1.7);
        ((GeneralPath) shape).lineTo(-0.18, 1.54);
        ((GeneralPath) shape).lineTo(0.21, 1.54);
        ((GeneralPath) shape).lineTo(1.38, -1.7);
        ((GeneralPath) shape).lineTo(0.98, -1.7);
        ((GeneralPath) shape).lineTo(0.02, 1.17);
        ((GeneralPath) shape).lineTo(-0.9, -1.7);
        ((GeneralPath) shape).lineTo(-1.33, -1.7);
        ((GeneralPath) shape).closePath();
