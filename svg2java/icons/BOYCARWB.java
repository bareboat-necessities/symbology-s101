...
public class BOYCARWB {
    ...
    public static void paint(Graphics2D g) {
        ...
        g.transform(new AffineTransform(3.7620301f, 0, 0, 3.7620301f, 7.7497816f, 22.964045f));
        ...
        // _0_0_4
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(0.75, -6.09);
        ((GeneralPath) shape).lineTo(2.25, -6.09);
        ((GeneralPath) shape).lineTo(1.26, -5.1);
        ((GeneralPath) shape).lineTo(0.75, -6.09);
        ((GeneralPath) shape).closePath();
        ...
        // _0_0_5
        shape = new GeneralPath();
        ((GeneralPath) shape).moveTo(1.68, -3.71);
        ((GeneralPath) shape).lineTo(0.18, -3.71);
        ((GeneralPath) shape).lineTo(1.17, -4.71);
        ((GeneralPath) shape).lineTo(1.68, -3.71);
        ((GeneralPath) shape).closePath();
